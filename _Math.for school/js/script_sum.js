...
function startGame() {
    ...
    clickableAnswers.forEach(function(elem) {
        elem.classList.remove('wrong', 'material-symbols-outlined');
        elem.classList.add('fontWeightNormal');
    })
    ...
    let wrongAnswer1 = Math.floor(Math.random() * 15 + 1);
    while (wrongAnswer1 == correctAnswer) {
        wrongAnswer1 = Math.floor(Math.random() * 15 + 1);
    }

    let wrongAnswer2 = Math.floor(Math.random() * 15 + 1);
    while (wrongAnswer2 == wrongAnswer1 || wrongAnswer2 == correctAnswer) {
        wrongAnswer2 = Math.floor(Math.random() * 15 + 1);
    }
